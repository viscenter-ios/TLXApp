...
//
//This VC is taken from one of iProd2's VC's. I have generalized it so that
//it can easily be used to inherit from when a simple table view is needed
//to display information from Core Data.
//entityName, keyName variables should be overridden when a class is 
